...
CREATE TABLE Butaca (
	ID_Butaca VARCHAR(10) NOT NULL,
	ID_Sala INT,
	Id_Sucursal INT,
	Fila INT,
	Columna VARCHAR(1),
	CONSTRAINT FK_SALA_BUTAKA FOREIGN KEY (Id_Sala,ID_Sucursal) REFERENCES SALA(Id_Sala,Id_sucursal),
...
CREATE TABLE Entrada (
	...
	Precio MONEY
	CONSTRAINT PK_Entrada PRIMARY KEY (id_butaca,id_entrada,id_funcion)
);
